...
SIM_TIME = 35 * 1e6  # us, total simulation time, run your final simulations with atleast 1000 seconds
...
ENABLE_OFFLOADING = False  # offloading or dropping
...
INITIAL_ENERGY = 1000 * 1e3  # in joule (This is the battery lifetime for the drone, you can change)
